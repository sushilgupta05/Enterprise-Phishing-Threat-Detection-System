...
class DataTranformation:
    def __init__(self, data_validation_artifacts: DataValidationArtifacts, 
        ...
        try:
            ...
            self.data_tranformation_config: DataTransformationConfig = data_tranformation_config
    ...
    def get_data_transformation_object(cls)-> Pipeline:
        ...
        """
        logging.info(
            "Entered get_data_transformation_object method of Transformation class"
        )
