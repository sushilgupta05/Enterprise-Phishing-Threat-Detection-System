...
class DataIngestionConfig:
    def __init__(self, training_pipeline_config:TrainingPipelineConfig):
        self.data_ingestion_dir:str = os.path.join(
            training_pipeline_config.artifact_dir, training_pipeline.DATA_INESTION_DIR_NAME
        )
        self.feature_store_file_path: str = os.path.join(
            self.data_ingestion_dir, training_pipeline.DATA_INESTION_FEATURE_STORE_DIR, training_pipeline.FILE_NAME
        )
        self.training_file_path:str = os.path.join(
            self.data_ingestion_dir, training_pipeline.DATA_INESTION_INGESTED_DIR,training_pipeline.TRAIN_FILE_NAME
        )
        self.testing_file_path:str = os.path.join(
            self.data_ingestion_dir, training_pipeline.DATA_INESTION_INGESTED_DIR, training_pipeline.TEST_FILE_NAME
        )
        self.train_test_spilt_ratio: float = training_pipeline.DATA_INESTION_TRAIN_TEST_SPLIT_RATIO
        self.collection_name: str = training_pipeline.DATA_INESTION_COLLECTION_NAME
        self.database_name:str = training_pipeline.DATA_INESTION_DATABASE_NAME
